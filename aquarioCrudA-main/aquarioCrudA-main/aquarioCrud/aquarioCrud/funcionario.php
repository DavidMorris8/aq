...
<body>
    ...
    include('navegacao.php')
        ?>
    <div class="container">
        <h2 class="text-center m-3">Lista dos Funcionário</h2>
        <p>
        ...
        <table class="table table-striped text-center border">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            <td>
                                <?php echo $objFuncionario['id']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionario['nome']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionario['idade']; ?>
                            </td>
                            <td>
                                <?php echo $objFuncionario['cpf']; ?>
                            </td>
                            <td>
                                <button 
                            ...
                            <td>
                                <button 
                                    ...
                                    data-id="<?php echo $objFuncionario['id']; ?>"
                                    data-nome="<?php echo $objFuncionario['nome']; ?>"> Deletar 
                                </button> 
                            </td>
                        </tr>
                <?php
